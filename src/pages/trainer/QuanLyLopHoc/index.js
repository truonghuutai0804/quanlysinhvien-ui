        ...
        <>
            <Container>
                <aside className="ms-4">
                    ...
                    <h2 className="my-5 text-center">QUẢN LÝ LỚP HỌC</h2>
                    <Button onClick={handleShowThemMoi} className="mb-3">
                        Thêm lớp học mới
                    </Button>
            ...
            <Modal show={showSuaLai} onHide={handleCloseSuaLai} animation={true} scrollable={true}>
                ...
                <Modal.Body className="show-grid">
                    <Form>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="text" value={editData.MA_LOP} disabled />
                        </Form.Group>
                        <Form.Group className="mb-3">
                            <Form.Label>
                                <strong>Tên khoa</strong>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={() => update(editData.MA_LOP)}>
                        Lưu lại
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal show={showXoa} onHide={handleCloseXoa} animation={true} scrollable={true}>
                ...
                <Modal.Body>
                    <p>
                        Bạn có chắc chắn xóa thông tin của lớp học <strong>{deleteData.TEN_LOP}</strong> này ?
                    </p>
                    <strong>Lưu ý:</strong> Nếu xóa thông tin sẽ mất vĩnh viễn
                </Modal.Body>
                <Modal.Footer>
                    <Button variant="danger" onClick={() => Delete(deleteData.MA_LOP)}>
                        Chắc chắn
                    </Button>

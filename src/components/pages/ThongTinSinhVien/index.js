    ...
    return (
        <>
                ...
                <Table bordered hover>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>44 (2018)</td>
                            <td>K.Công nghệ Thông tin &Truyền thông</td>
                            <td className="table-text-center">
                                <strong to="/ThongTinSinhVien" className="infor-see" onClick={handleShowXemThongTin}>
                                    <FaEye />
                                </strong>
                                <strong to="/ThongTinSinhVien" className="infor-edit" onClick={handleShowSuaLai}>
                                    <FaEdit />
                                </strong>
                                <strong to="/ThongTinSinhVien" className="infor-remove" onClick={handleShowXoa}>
                                    <FaTrashAlt />
                                </strong>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>K.Công nghệ Thông tin &Truyền thông</td>
                            <td className="table-text-center">
                                <Link to="/ThongTinSinhVien" className="infor-see" onClick={handleShowXemThongTin}>
                                    <FaEye />
                                </Link>
                                <Link to="/ThongTinSinhVien" className="infor-edit" onClick={handleShowSuaLai}>
                                    <FaEdit />
                                </Link>
                                <Link to="/ThongTinSinhVien" className="infor-remove" onClick={handleShowXoa}>
                                    <FaTrashAlt />
                                </Link>
                            </td>
                        </tr>
                            ...
                            <Col xs={12} md={8}>
                                <Form>
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control type="text" value="B1809509" disabled />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                                        <Form.Label>
                                            <strong>Họ Tên</strong>
            ...
            <Modal show={showXoa} onHide={handleCloseXoa} animation={true} scrollable={true}>
                ...
                <Modal.Body>
                    <h4>Bạn có chắc chắn xóa thông tin của sinh viên này ?</h4>
